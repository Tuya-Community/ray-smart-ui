  ...
  return (
    <>
      ...
      <DemoBlock title={Strings.getLang('customColor')} padding>
        <Tag className="demo-margin-right" color="rgba(16, 208, 208, 1)">
          {Strings.getLang('label')}
        </Tag>
        <Tag
          className="demo-margin-right"
          color="rgba(16, 208, 208, 0.2)"
          textColor="rgba(16, 208, 208, 1)"
        >
          {Strings.getLang('label')}
        </Tag>
        <Tag className="demo-margin-right" color="rgba(16, 208, 208, 1)" plain>
          {Strings.getLang('label')}
        </Tag>
      </DemoBlock>
