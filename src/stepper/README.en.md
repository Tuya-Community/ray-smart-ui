...
| minusAriaLabel `v2.13.0` | Accessible label for the minus button | _string_ | - |
| name | Identifier when submitting in a form | _string_ | - |
| plusAriaLabel `v2.13.0` | Accessible label for the plus button | _string_ | - |
...
| step | Step size2.13.0ring \| number_ | `1` |
