...
| -------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------ | --------------------------------------- |
| closeIconAriaLabel `v2.12.1` | Accessible label for the title close icon, passed to inner `smart-icon` as `aria-label`; when omitted, the icon still has `button` role via `aria-role` so apps can add i18n when needed | _string_ | - |
