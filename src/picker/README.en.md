...
| activeStyle `v2.0.0` | Style in selected state | _React.CSSProperties_ | - |
...
| fontStyle `v2.7.0` | Font style has lower priority than within columns | _React.CSSProperties_ | - |
