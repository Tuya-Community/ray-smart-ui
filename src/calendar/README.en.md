...
| --calendar-header-title-save-color                       | _#1989fa_                               | Calendar header save button color     |
...
| --calendar-popup-height-month `v2.13.0`            | _350px_                                 | Calendar popup height in month mode   |
| --calendar-popup-height-year `v2.13.0`             | _350px_                                 | Calendar popup height in year mode    |
